...
METHODS = [
    ...
    Method("space_v2", "SPACE-v2 (B+C+J)", "space_v2"),
    Method("space_v2_b", "SPACE-v2-B (attn1+attn2)", "space_v2_b"),
    Method("space_v2_c", "SPACE-v2-C (dense traj)", "space_v2_c"),
    Method("space_v2_j", "SPACE-v2-J (prompt weight)", "space_v2_j"),
    Method("space_v2r_e125", "SPACE-v2R e125", "space_v2r_e125"),
    Method("space_v2r_e175", "SPACE-v2R e175", "space_v2r_e175"),
    Method("space_v2r_e225", "SPACE-v2R e225", "space_v2r_e225"),
    Method("space_v2r_e175_top35", "SPACE-v2R e175 top35", "space_v2r_e175_top35"),
    Method("space_v3", "SPACE-v3", "space_v3"),
]
...
ARTISTS = [
    {
        ...
        "space_v2": "results/space_v2/space-Kelly_McKernan",
        "space_v2r_e175": "results/space_v2r_e175/space-Kelly_McKernan",
        "space_v3": "results/space_v3/space-Kelly_McKernan",
    },
    {
        "name": "Van Gogh",
        ...
        "space_v2": "results/space_v2/space-Van_Gogh",
        "space_v2_b": "results/space_v2_b/space-Van_Gogh_B",
        "space_v2_c": "results/space_v2_c/space-Van_Gogh_C",
        "space_v2_j": "results/space_v2_j/space-Van_Gogh_J",
        "space_v2r_e125": "results/space_v2r_e125/space-Van_Gogh",
        "space_v2r_e175": "results/space_v2r_e175/space-Van_Gogh",
        "space_v2r_e225": "results/space_v2r_e225/space-Van_Gogh",
        "space_v2r_e175_top35": "results/space_v2r_e175_top35/space-Van_Gogh",
        "space_v3": "results/space_v3/space-Van_Gogh",
    },
    {
        "name": "Tyler Edlin",
        ...
        "space_v2": "results/space_v2/space-Tyler_Edlin",
        "space_v2r_e175": "results/space_v2r_e175/space-Tyler_Edlin",
        "space_v3": "results/space_v3/space-Tyler_Edlin",
    },
    {
        "name": "Thomas Kinkade",
        "csv": "data/short_niche_art_prompts.csv",
        ...
        "space": "results/space/space-Thomas_Kinkade",
        "space_v2": "results/space_v2/space-Thomas_Kinkade",
        "space_v2r_e175": "results/space_v2r_e175/space-Thomas_Kinkade",
        "space_v3": "results/space_v3/space-Thomas_Kinkade",
    },
    {
        "name": "Kilian Eng",
        "csv": "data/short_niche_art_prompts.csv",
        ...
        "space_v2": "results/space_v2/space-Kilian_Eng",
        "space_v2r_e175": "results/space_v2r_e175/space-Kilian_Eng",
        "space_v3": "results/space_v3/space-Kilian_Eng",
    },
    {
        ...
        "space_v2": "results/space_v2/space-Ajin_Demi_Human",
        "space_v2r_e175": "results/space_v2r_e175/space-Ajin_Demi_Human",
        "space_v3": "results/space_v3/space-Ajin_Demi_Human",
    },
    {
        "name": "Andy Warhol",
        "csv": "data/andy_warhol_prompts.csv",
        "baseline": "results/baseline/andy_warhol",
        "erased": "results/erased/andy_warhol",
        "uce": "results/uce/uce-Andy_Warhol",
        "concept_ablation_diffusers": "results/concept_ablation_diffusers/concept_ablation-Andy_Warhol",
        "space": "results/space/space-Andy_Warhol",
    },
]
...
def main():
    ...
    if args.strict_validation:
        ...
        space_v2r_root = "space-models/sd-v2r"
        space_v3_root = "space-models/sd-v3"
        ...
        for cfg in strict_artists:
            ...
            for method in methods:
                if not method.key.startswith("space_v2r_"):
                    continue
                suffix = method.key.replace("space_", "")
                space_ckpt = os.path.join(space_v2r_root, f"space-{sanitize_name(artist)}_{suffix}.safetensors")
                if not os.path.exists(space_ckpt):
                    missing.append(f"Missing SPACE-v2R checkpoint: {space_ckpt}")
                space_dir = cfg.get(method.path_key)
                if not space_dir or not os.path.isdir(space_dir) or not all_pngs(space_dir):
                    missing.append(f"Missing/empty SPACE-v2R image directory: {space_dir}")
            if any(method.key == "space_v3" for method in methods):
                space_ckpt = os.path.join(space_v3_root, f"space-{sanitize_name(artist)}_v3.safetensors")
                if not os.path.exists(space_ckpt):
                    missing.append(f"Missing SPACE-v3 checkpoint: {space_ckpt}")
                space_dir = cfg.get("space_v3")
                if not space_dir or not os.path.isdir(space_dir) or not all_pngs(space_dir):
                    missing.append(f"Missing/empty SPACE-v3 image directory: {space_dir}")
        if missing:
